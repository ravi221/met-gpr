...
/**
 * An interface to represent the default values for the datepicker component
 */
export interface DatePickerDefaultsInterface {
    /**
...
/**
 * A default implementation of the datepicker's values
 */
@Injectable()
export class DatePickerDefaults implements DatePickerDefaultsInterface {
    /**
     * Exactly the same as date format, but for the altInput field.
     */
